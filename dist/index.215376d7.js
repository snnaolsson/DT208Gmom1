...
})({"hjJew":[function(require,module,exports) {
...
function addCourse() {
    const kurscode = document.getElementById("kurskod").value.toUpperCase();
    const kursname = document.getElementById("kursnamn").value;
    const kursprogInput = document.getElementById("progression").value.toUpperCase();
    let kursprog;
    ...
    if (!doubles) {
        ...
        if (kursprogInput === "A" || kursprogInput === "B" || kursprogInput === "C") kursprog = kursprogInput;
        else {
            console.log("Ogiltig progression! Progression kan endast vara A, B eller C");
            return;
        }
        ...
        printCourses();
    } else console.log("Kurskoden finns redan. Kurskoden m\xe5ste vara unik!");
}
...
function printCourses() {
    ...
    for(let i = 0; i < courses.length; i++){
        ...
        courseLi.textContent = courses[i].code + courses[i].name + courses[i].progression + courses[i].syllabus;
        courseContainer?.appendChild(courseLi);
    //courseLi.addEventListener("click", () => {});
    }
} //funktion för att uppdatera kurs

},{}]},["hjJew","iGpzc"], "iGpzc", "parcelRequire6e64")
